import {createNote, createWaveNote, waveBufferNode, joinSource, Playback, Source} from '../src/index.js';
...
const scc=waveBufferNode(audioCtx, wdat, {lambda: 1024});
...
export async function playSound() {
    ...
    for (let i = 0; i < 12; i++) {
        const src=createWaveNote(1, 440*Math.pow(2,i/12), 0.5, scc, {
